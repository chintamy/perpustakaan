...
<body>
    ...
    <form action="" method="POST">
        ...
        <input value="<?php echo $buku ['nama'] ?>" type="text" id="nama" name="nama"></input><br>
        
        <br>

        <label for="isbn">ISBN</label>
        <input value="<?php echo $buku ['isbn'] ?>" type="number" id="isbn" name="isbn"></input><br>

        <br>

        <label for="unit">Unit</label>
        <input value="<?php echo $buku ['unit'] ?>" type="number" id="unit" name="unit"></input><br>
